...
sum(distanceToNearest(crm8008.gr,tss.gr)$distance>intergenic_dist)
...
nontssnum<-sum(distanceToNearest(crm8008.gr,tss.gr)$distance>intergenic_dist)
oldnontssnum<-sum(distanceToNearest(crm8008.gr,tss.old)$distance>intergenic_dist)


sum(distanceToNearest(crm8008.gr,transcripts)$distance>intergenic_dist)
sum(distanceToNearest(crm8008.gr,transcripts.old)$distance>intergenic_dist)
