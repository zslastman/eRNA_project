# ###This script loads the information on the CAD3 CRMs for the CAGE project
# # packages ----------------------------------------------------------------
# message('loading cad data ')
 library(BSgenome)
# library(multicore)
...
# trfile="/g/furlong/Harnett/data_general/FBannotation_db.tab"
